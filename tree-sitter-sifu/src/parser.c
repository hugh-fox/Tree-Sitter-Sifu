...
enum ts_symbol_identifiers {
  ...
  sym_terms = 39,
  sym__term = 40,
  sym_nested_pattern = 41,
  sym_nested_trie = 42,
  sym_quote = 43,
  aux_sym_terms_repeat1 = 44,
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_comma] = sym_comma,
  [sym_indent_group] = sym_indent_group,
...
static const TSCharacterRange sym_key_character_set_1[] = {
  {'-', '-'}, {'A', 'Z'}, {'_', '_'}, {0xc0, 0xd6}, {0xd8, 0xde}, {0x100, 0x100}, {0x102, 0x102}, {0x104, 0x104},
...
static const TSCharacterRange sym_constant_character_set_1[] = {
...
static const TSCharacterRange sym_var_pattern_character_set_1[] = {
...
static const TSCharacterRange sym_symbol_character_set_1[] = {
  {'!', '!'}, {'$', '&'}, {'*', '+'}, {'-', '-'}, {'/', '/'}, {':', ':'}, {'<', '@'}, {'[', '^'},
  {'`', '`'}, {'|', '|'}, {'~', '~'}, {0xa2, 0xa6}, {0xa8, 0xa9}, {0xac, 0xac}, {0xae, 0xb1}, {0xb4, 0xb4},
  {0xb8, 0xb8}, {0xd7, 0xd7}, {0xf7, 0xf7}, {0x2c2, 0x2c5}, {0x2d2, 0x2df}, {0x2e5, 0x2eb}, {0x2ed, 0x2ed}, {0x2ef, 0x2ff},
  {0x375, 0x375}, {0x384, 0x385}, {0x3f6, 0x3f6}, {0x482, 0x482}, {0x58d, 0x58f}, {0x606, 0x608}, {0x60b, 0x60b}, {0x60e, 0x60f},
  {0x6de, 0x6de}, {0x6e9, 0x6e9}, {0x6fd, 0x6fe}, {0x7f6, 0x7f6}, {0x7fe, 0x7ff}, {0x888, 0x888}, {0x9f2, 0x9f3}, {0x9fa, 0x9fb},
  {0xaf1, 0xaf1}, {0xb70, 0xb70}, {0xbf3, 0xbfa}, {0xc7f, 0xc7f}, {0xd4f, 0xd4f}, {0xd79, 0xd79}, {0xe3f, 0xe3f}, {0xf01, 0xf03},
  {0xf13, 0xf13}, {0xf15, 0xf17}, {0xf1a, 0xf1f}, {0xf34, 0xf34}, {0xf36, 0xf36}, {0xf38, 0xf38}, {0xfbe, 0xfc5}, {0xfc7, 0xfcc},
  {0xfce, 0xfcf}, {0xfd5, 0xfd8}, {0x109e, 0x109f}, {0x1390, 0x1399}, {0x166d, 0x166d}, {0x17db, 0x17db}, {0x1940, 0x1940}, {0x19de, 0x19ff},
  {0x1b61, 0x1b6a}, {0x1b74, 0x1b7c}, {0x1fbd, 0x1fbd}, {0x1fbf, 0x1fc1}, {0x1fcd, 0x1fcf}, {0x1fdd, 0x1fdf}, {0x1fed, 0x1fef}, {0x1ffd, 0x1ffe},
  {0x2044, 0x2044}, {0x2052, 0x2052}, {0x207a, 0x207c}, {0x208a, 0x208c}, {0x20a0, 0x20c0}, {0x2100, 0x2101}, {0x2103, 0x2106}, {0x2108, 0x2109},
  ...
  {0x2b76, 0x2b95}, {0x2b97, 0x2bff}, {0x2ce5, 0x2cea}, {0x2e50, 0x2e51}, {0x2e80, 0x2e99}, {0x2e9b, 0x2ef3}, {0x2f00, 0x2fd5}, {0x2ff0, 0x2fff},
  {0x3004, 0x3004}, {0x3012, 0x3013}, {0x3020, 0x3020}, {0x3036, 0x3037}, {0x303e, 0x303f}, {0x309b, 0x309c}, {0x3190, 0x3191}, {0x3196, 0x319f},
  {0x31c0, 0x31e5}, {0x31ef, 0x31ef}, {0x3200, 0x321e}, {0x322a, 0x3247}, {0x3250, 0x3250}, {0x3260, 0x327f}, {0x328a, 0x32b0}, {0x32c0, 0x33ff},
  {0x4dc0, 0x4dff}, {0xa490, 0xa4c6}, {0xa700, 0xa716}, {0xa720, 0xa721}, {0xa789, 0xa78a}, {0xa828, 0xa82b}, {0xa836, 0xa839}, {0xaa77, 0xaa79},
  {0xab5b, 0xab5b}, {0xab6a, 0xab6b}, {0xfb29, 0xfb29}, {0xfbb2, 0xfbc2}, {0xfd40, 0xfd4f}, {0xfdcf, 0xfdcf}, {0xfdfc, 0xfdff}, {0xfe62, 0xfe62},
  {0xfe64, 0xfe66}, {0xfe69, 0xfe69}, {0xff04, 0xff04}, {0xff0b, 0xff0b}, {0xff1c, 0xff1e}, {0xff3e, 0xff3e}, {0xff40, 0xff40}, {0xff5c, 0xff5c},
  {0xff5e, 0xff5e}, {0xffe0, 0xffe6}, {0xffe8, 0xffee}, {0xfffc, 0xfffd}, {0x10137, 0x1013f}, {0x10179, 0x10189}, {0x1018c, 0x1018e}, {0x10190, 0x1019c},
  {0x101a0, 0x101a0}, {0x101d0, 0x101fc}, {0x10877, 0x10878}, {0x10ac8, 0x10ac8}, {0x10d8e, 0x10d8f}, {0x1173f, 0x1173f}, {0x11fd5, 0x11ff1}, {0x16b3c, 0x16b3f},
  {0x16b45, 0x16b45}, {0x1bc9c, 0x1bc9c}, {0x1cc00, 0x1ccef}, {0x1cd00, 0x1ceb3}, {0x1cf50, 0x1cfc3}, {0x1d000, 0x1d0f5}, {0x1d100, 0x1d126}, {0x1d129, 0x1d164},
  ...
  {0x1f300, 0x1f6d7}, {0x1f6dc, 0x1f6ec}, {0x1f6f0, 0x1f6fc}, {0x1f700, 0x1f776}, {0x1f77b, 0x1f7d9}, {0x1f7e0, 0x1f7eb}, {0x1f7f0, 0x1f7f0}, {0x1f800, 0x1f80b},
  {0x1f810, 0x1f847}, {0x1f850, 0x1f859}, {0x1f860, 0x1f887}, {0x1f890, 0x1f8ad}, {0x1f8b0, 0x1f8bb}, {0x1f8c0, 0x1f8c1}, {0x1f900, 0x1fa53}, {0x1fa60, 0x1fa6d},
  {0x1fa70, 0x1fa7c}, {0x1fa80, 0x1fa89}, {0x1fa8f, 0x1fac6}, {0x1face, 0x1fadc}, {0x1fadf, 0x1fae9}, {0x1faf0, 0x1faf8}, {0x1fb00, 0x1fb92}, {0x1fb94, 0x1fbef},
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_key_character_set_1, 653, lookahead)) ADVANCE(36);
      if (set_contains(sym_var_pattern_character_set_1, 662, lookahead)) ADVANCE(38);
      if (set_contains(sym_symbol_character_set_1, 240, lookahead)) ADVANCE(52);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(33);
    ...
    case 11:
      ...
      END_STATE();
    case 12:
      if (set_contains(sym_var_pattern_character_set_1, 662, lookahead)) ADVANCE(39);
      END_STATE();
    case 13:
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(4);
    ...
    case 36:
      ACCEPT_TOKEN(sym_key);
      if (set_contains(sym_key_character_set_2, 772, lookahead)) ADVANCE(36);
      END_STATE();
    case 37:
      ACCEPT_TOKEN(sym_constant);
      if (set_contains(sym_key_character_set_2, 772, lookahead)) ADVANCE(37);
      END_STATE();
    case 38:
      ACCEPT_TOKEN(sym_variable);
      if (set_contains(sym_key_character_set_2, 772, lookahead)) ADVANCE(38);
      END_STATE();
    case 39:
      ACCEPT_TOKEN(sym_var_pattern);
      if (set_contains(sym_key_character_set_2, 772, lookahead)) ADVANCE(39);
      END_STATE();
    case 40:
    ...
    case 53:
      ACCEPT_TOKEN(sym_symbol);
      if (set_contains(sym_symbol_character_set_1, 240, lookahead)) ADVANCE(52);
      if (set_contains(sym_constant_character_set_1, 771, lookahead)) ADVANCE(37);
      END_STATE();
    case 54:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym__prec1] = STATE(84),
    [sym_semicolon] = STATE(84),
    [sym_newline_sep] = STATE(84),
    [sym__prec2] = STATE(76),
    [sym_long_match] = STATE(76),
    [sym_long_arrow] = STATE(76),
    [sym__prec3] = STATE(70),
    [sym_comma] = STATE(70),
    [sym_indent_group] = STATE(70),
    [sym__prec4] = STATE(59),
    [sym_infix] = STATE(59),
    [sym__prec5] = STATE(51),
    [sym_match] = STATE(51),
    ...
    [sym_terms] = STATE(50),
    [sym__term] = STATE(43),
    [sym_nested_pattern] = STATE(43),
    [sym_nested_trie] = STATE(43),
    [sym_quote] = STATE(43),
    [aux_sym_terms_repeat1] = STATE(43),
    [ts_builtin_sym_end] = ACTIONS(3),
    [anon_sym_SEMI] = ACTIONS(5),
    [anon_sym_COLON_COLON] = ACTIONS(7),
    [anon_sym_DASH_DASH_GT] = ACTIONS(9),
    ...
    [sym_single_string] = ACTIONS(29),
    [sym_symbol] = ACTIONS(31),
    [sym_comment] = ACTIONS(29),
  },
  [STATE(2)] = {
    [sym__prec1] = STATE(80),
    [sym_semicolon] = STATE(80),
    [sym_newline_sep] = STATE(80),
    [sym__prec2] = STATE(76),
    [sym_long_match] = STATE(76),
    [sym_long_arrow] = STATE(76),
    [sym__prec3] = STATE(70),
  ...
  [STATE(3)] = {
    [sym__prec1] = STATE(78),
    [sym_semicolon] = STATE(78),
    [sym_newline_sep] = STATE(78),
    [sym__prec2] = STATE(76),
    [sym_long_match] = STATE(76),
    [sym_long_arrow] = STATE(76),
    [sym__prec3] = STATE(70),
  ...
  [STATE(4)] = {
    [sym__prec1] = STATE(79),
    [sym_semicolon] = STATE(79),
    [sym_newline_sep] = STATE(79),
    [sym__prec2] = STATE(76),
    [sym_long_match] = STATE(76),
    [sym_long_arrow] = STATE(76),
    [sym__prec3] = STATE(70),
  ...
  [STATE(5)] = {
    [sym__prec1] = STATE(83),
    [sym_semicolon] = STATE(83),
    [sym_newline_sep] = STATE(83),
    [sym__prec2] = STATE(81),
    [sym_long_match] = STATE(81),
    [sym_long_arrow] = STATE(81),
    [sym__prec3] = STATE(75),
    [sym_comma] = STATE(75),
    [sym_indent_group] = STATE(75),
    [sym__prec4] = STATE(69),
    [sym_infix] = STATE(69),
    [sym__prec5] = STATE(66),
    [sym_match] = STATE(66),
    ...
    [sym_terms] = STATE(57),
    [sym__term] = STATE(44),
    [sym_nested_pattern] = STATE(44),
    [sym_nested_trie] = STATE(44),
    [sym_quote] = STATE(44),
    [aux_sym_terms_repeat1] = STATE(44),
    ...
    [sym_single_string] = ACTIONS(39),
    [sym_symbol] = ACTIONS(41),
    [sym_comment] = ACTIONS(39),
  },
  [STATE(6)] = {
    [sym__prec1] = STATE(77),
    [sym_semicolon] = STATE(77),
    [sym_newline_sep] = STATE(77),
    [sym__prec2] = STATE(76),
    [sym_long_match] = STATE(76),
    [sym_long_arrow] = STATE(76),
    [sym__prec3] = STATE(70),
  ...
  [STATE(7)] = {
    [sym__prec1] = STATE(85),
    [sym_semicolon] = STATE(85),
    [sym_newline_sep] = STATE(85),
    [sym__prec2] = STATE(76),
    [sym_long_match] = STATE(76),
    [sym_long_arrow] = STATE(76),
    [sym__prec3] = STATE(70),
  ...
  [STATE(9)] = {
    [sym__prec2] = STATE(74),
    [sym_long_match] = STATE(74),
    [sym_long_arrow] = STATE(74),
    [sym__prec3] = STATE(70),
    [sym_comma] = STATE(70),
    [sym_indent_group] = STATE(70),
    [sym__prec4] = STATE(59),
  ...
  [STATE(10)] = {
    [sym__prec2] = STATE(73),
    [sym_long_match] = STATE(73),
    [sym_long_arrow] = STATE(73),
    [sym__prec3] = STATE(70),
    [sym_comma] = STATE(70),
    [sym_indent_group] = STATE(70),
    [sym__prec4] = STATE(59),
  ...
  [STATE(11)] = {
    ...
    [sym_single_string] = ACTIONS(73),
    [sym_symbol] = ACTIONS(75),
    [sym_comment] = ACTIONS(73),
  },
  [STATE(12)] = {
    [sym__prec2] = STATE(72),
    [sym_long_match] = STATE(72),
    [sym_long_arrow] = STATE(72),
    [sym__prec3] = STATE(70),
    [sym_comma] = STATE(70),
    [sym_indent_group] = STATE(70),
    [sym__prec4] = STATE(59),
  ...
  [STATE(13)] = {
    [sym__prec2] = STATE(71),
    [sym_long_match] = STATE(71),
    [sym_long_arrow] = STATE(71),
    [sym__prec3] = STATE(70),
    [sym_comma] = STATE(70),
    [sym_indent_group] = STATE(70),
    [sym__prec4] = STATE(59),
  ...
  [STATE(22)] = {
    ...
    [anon_sym_DASH_DASH_GT] = ACTIONS(95),
    [anon_sym_COMMA] = ACTIONS(11),
    [anon_sym_COLON] = ACTIONS(13),
    [anon_sym_DASH_GT] = ACTIONS(15),
    [anon_sym_LPAREN] = ACTIONS(17),
  ...
  [STATE(28)] = {
    ...
    [anon_sym_DASH_DASH_GT] = ACTIONS(103),
  ...
  [STATE(32)] = {
    ...
    [anon_sym_BQUOTE] = ACTIONS(21),
    [sym_newline] = ACTIONS(105),
    [sym_indent] = ACTIONS(105),
    [sym_key] = ACTIONS(27),
    [sym_constant] = ACTIONS(29),
    [sym_variable] = ACTIONS(29),
    [sym_var_pattern] = ACTIONS(29),
  ...
  [STATE(33)] = {
    ...
    [anon_sym_DASH_DASH_GT] = ACTIONS(111),
    ...
    [anon_sym_BQUOTE] = ACTIONS(21),
    [sym_newline] = ACTIONS(109),
    [sym_indent] = ACTIONS(109),
    [sym_key] = ACTIONS(27),
    [sym_constant] = ACTIONS(29),
    [sym_variable] = ACTIONS(29),
    [sym_var_pattern] = ACTIONS(29),
  ...
  [STATE(42)] = {
    [sym__term] = STATE(42),
    [sym_nested_pattern] = STATE(42),
    [sym_nested_trie] = STATE(42),
    [sym_quote] = STATE(42),
    [aux_sym_terms_repeat1] = STATE(42),
    ...
    [sym_newline] = ACTIONS(121),
    [sym_indent] = ACTIONS(121),
    [sym_key] = ACTIONS(134),
    [sym_constant] = ACTIONS(137),
    [sym_variable] = ACTIONS(137),
    [sym_var_pattern] = ACTIONS(137),
    [sym_number] = ACTIONS(137),
    [sym_string] = ACTIONS(137),
    [sym_single_string] = ACTIONS(137),
  ...
  [STATE(43)] = {
    ...
    [anon_sym_BQUOTE] = ACTIONS(21),
    [sym_newline] = ACTIONS(140),
    [sym_indent] = ACTIONS(140),
    [sym_key] = ACTIONS(144),
    [sym_constant] = ACTIONS(146),
    [sym_variable] = ACTIONS(146),
    [sym_var_pattern] = ACTIONS(146),
    [sym_number] = ACTIONS(146),
    [sym_string] = ACTIONS(146),
    [sym_single_string] = ACTIONS(146),
  ...
  [STATE(46)] = {
    ...
    [sym_indent] = ACTIONS(152),
    [sym_key] = ACTIONS(154),
    [sym_constant] = ACTIONS(152),
    [sym_variable] = ACTIONS(152),
    [sym_var_pattern] = ACTIONS(152),
    [sym_number] = ACTIONS(152),
    [sym_string] = ACTIONS(152),
    [sym_single_string] = ACTIONS(152),
  ...
  [STATE(47)] = {
    ...
    [sym_newline] = ACTIONS(156),
    [sym_indent] = ACTIONS(156),
    [sym_key] = ACTIONS(158),
    [sym_constant] = ACTIONS(156),
    [sym_variable] = ACTIONS(156),
    [sym_var_pattern] = ACTIONS(156),
    [sym_number] = ACTIONS(156),
    [sym_string] = ACTIONS(156),
    [sym_single_string] = ACTIONS(156),
  ...
  [STATE(48)] = {
    ...
    [anon_sym_DASH_DASH_GT] = ACTIONS(162),
    ...
    [sym_newline] = ACTIONS(160),
    [sym_indent] = ACTIONS(160),
    [sym_key] = ACTIONS(162),
    [sym_constant] = ACTIONS(160),
    [sym_variable] = ACTIONS(160),
    [sym_var_pattern] = ACTIONS(160),
    [sym_number] = ACTIONS(160),
    [sym_string] = ACTIONS(160),
    [sym_single_string] = ACTIONS(160),
  ...
  [STATE(49)] = {
    ...
    [sym_newline] = ACTIONS(164),
    [sym_indent] = ACTIONS(164),
    [sym_key] = ACTIONS(166),
    [sym_constant] = ACTIONS(164),
    [sym_variable] = ACTIONS(164),
    [sym_var_pattern] = ACTIONS(164),
    [sym_number] = ACTIONS(164),
    [sym_string] = ACTIONS(164),
    [sym_single_string] = ACTIONS(164),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_semicolon, 1, 0, 0),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_semicolon, 2, 0, 4),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_newline_sep, 1, 0, 0),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quote, 2, 0, 0),
  [41] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quote, 2, 0, 0),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_newline_sep, 2, 0, 4),
  [45] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [47] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_long_match, 1, 0, 0),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_long_arrow, 1, 0, 0),
  ...
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_long_arrow, 2, 0, 4),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_long_match, 2, 0, 4),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_indent_group, 1, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_indent_group, 1, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comma, 1, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comma, 1, 0, 0),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comma, 2, 0, 4),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comma, 2, 0, 4),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_indent_group, 2, 0, 4),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_indent_group, 2, 0, 4),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_infix, 1, 0, 1),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_infix, 1, 0, 1),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_infix, 2, 0, 5),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_infix, 2, 0, 5),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arrow, 1, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arrow, 1, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arrow, 2, 0, 4),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arrow, 2, 0, 4),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match, 1, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match, 1, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match, 2, 0, 4),
  [119] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match, 2, 0, 4),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_terms_repeat1, 2, 0, 0),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_terms_repeat1, 2, 0, 0),
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_terms_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [128] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_terms_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  [131] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_terms_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [134] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_terms_repeat1, 2, 0, 0), SHIFT_REPEAT(42),
  [137] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_terms_repeat1, 2, 0, 0), SHIFT_REPEAT(42),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_terms, 1, 0, 0),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_terms, 1, 0, 0),
  [144] = {.entry = {.count = 1, .reusable = false}}, SHIFT(42),
  [146] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nested_pattern, 2, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_nested_pattern, 2, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nested_trie, 2, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_nested_trie, 2, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quote, 3, 0, 6),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quote, 3, 0, 6),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nested_trie, 3, 0, 6),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_nested_trie, 3, 0, 6),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nested_pattern, 3, 0, 6),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_nested_pattern, 3, 0, 6),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__prec5, 1, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__prec5, 1, 0, 0),
  [172] = {.entry = {.count = 1, .reusable = false}}, SHIFT(35),
  [174] = {.entry = {.count = 1, .reusable = false}}, SHIFT(33),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__prec4, 1, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__prec4, 1, 0, 0),
  [180] = {.entry = {.count = 1, .reusable = false}}, SHIFT(28),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match, 2, 0, 2),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match, 2, 0, 2),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arrow, 2, 0, 2),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arrow, 2, 0, 2),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_infix, 3, 0, 8),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match, 3, 0, 7),
  [194] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match, 3, 0, 7),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arrow, 3, 0, 7),
  [198] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arrow, 3, 0, 7),
  [200] = {.entry = {.count = 1, .reusable = false}}, SHIFT(39),
  [202] = {.entry = {.count = 1, .reusable = false}}, SHIFT(38),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_infix, 2, 0, 3),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__prec3, 1, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [210] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_indent_group, 3, 0, 7),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comma, 3, 0, 7),
  [216] = {.entry = {.count = 1, .reusable = false}}, SHIFT(37),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comma, 2, 0, 2),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_indent_group, 2, 0, 2),
  [222] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [224] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__prec2, 1, 0, 0),
  [228] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [230] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_long_match, 3, 0, 7),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_long_arrow, 3, 0, 7),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_long_arrow, 2, 0, 2),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_long_match, 2, 0, 2),
  [240] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [242] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__prec1, 1, 0, 0),
  [246] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [248] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_newline_sep, 3, 0, 7),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_semicolon, 3, 0, 7),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_newline_sep, 2, 0, 2),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_semicolon, 2, 0, 2),
